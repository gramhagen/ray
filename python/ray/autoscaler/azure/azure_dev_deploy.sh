...
blob_account_name=myblobaccount

yaml=$ray_home/python/ray/autoscaler/azure/example-full.yaml
...
echo ssh -L 8265:localhost:8265 -L 8899:localhost:8899 -o IdentitiesOnly=yes -i ~/.ssh/ray_azure_${rg}_ubuntu.pem ubuntu@10.0